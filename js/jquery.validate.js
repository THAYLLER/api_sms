...
$.extend($.validator, {
	...
	messages: {
		...
		digits: "Por favor, insira os d&iacute;gitos apenas.",
		creditcard: "Por favor, insira um n&uacute;mero v&aacute;lido de cart&atilde;o de cr&eacute;dito.",
		equalTo: "Por favor, digite o mesmo valor novamente.",
		accept: "Por favor, insira um valor com uma extens&atilde;o v&aacute;lida.",
		maxlength: $.validator.format("Por favor, insira no m&aacute;ximo {0} caracteres."),
		minlength: $.validator.format("Por favor, insira pelo menos {0} caracteres."),
		rangelength: $.validator.format("Por favor, insira de {0} a {1} caracteres."),
